...
typedef struct {
    uint32_t
    api;   ///< API version (major.minor.rev: mmnnnrrrr dec).
    uint32_t
    kernel;   ///< Kernel version (major.minor.rev: mmnnnrrrr dec).
} osVersion_t;
...
typedef struct {
    ...
    uint32_t
    cb_size;   ///< size of provided memory for control block
...
typedef struct {
    ...
    uint32_t
    mp_size;   ///< size of provided memory for data storage
} osMemoryPoolAttr_t;
...
typedef struct {
    ...
    uint32_t
    mq_size;   ///< size of provided memory for data storage
