...
typedef struct {
    ...
    uint32_t EWIMode
    ;      /*!< Specifies if WWDG Early Wakeup Interrupt is enable or not.
...
#endif /* USE_HAL_WWDG_REGISTER_CALLBACKS */
{
    ...
    void (* MspInitCallback)(struct __WWDG_HandleTypeDef
                             *hwwdg);              /*!< WWDG Msp Init callback */
#endif /* USE_HAL_WWDG_REGISTER_CALLBACKS */
} WWDG_HandleTypeDef;
...
/**
  ...
  */
typedef void (*pWWDG_CallbackTypeDef)(WWDG_HandleTypeDef
